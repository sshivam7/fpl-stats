            ...
            <Parallax pages={TOTAL_PAGES}>
                ...
                <ParallaxLayer offset={0} sticky={{start: 0, end: 2}}>
                    <div className="absolute top-1 left-0 w-full h-[7%]">
                        <div className="flex justify-center px-3 md:px-9 md:justify-start">
                            <Link href="#overview">
                                <a className="text-black font-stat text-2xl tracking-wide p-2 md:p-5 hover:text-purple-500">Overview</a>
                            </Link>
                            <Link href="#get-started">
                                <a className="text-black font-stat text-2xl tracking-wide p-2 md:p-5 hover:text-rose-500 ">My Stats</a>
                            </Link>
                            <Link href="#faq">
                                <a className="text-black font-stat text-2xl tracking-wide p-2 md:p-5 hover:text-pink-600">FAQ & About</a>
                            </Link>
                        </div>
                    </div>
                ...
                <ParallaxLayer offset={2} className="bg-background invisible lg:visible">
                ...
                <ParallaxLayer id="overview" offset={3} factor={2} className="bg-gradient-to-b from-background to-cyan-400">
                    <div className="flex flex-col h-full">
                        <div className="w-full lg:w-2/3 h-full mx-auto text-center">
                            <h2 className="mb-2 mt-40 font-poppins font-bold bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600
                                        text-transparent text-6xl md:text-9xl">
                                <span className="text-6xl md:text-9xl text-neutral-800">&nbsp;Overview&nbsp;</span> and Statistics
                            </h2>
                ...
                <ParallaxLayer offset={4} speed={0.25} className="invisible lg:visible">
                    <h3 className="absolute right-0 top-1/2 font-stat tracking-wide text-6xl bg-clip-text bg-gradient-to-tr from-purple-400 to-pink-600
                                        text-transparent rotate-90">Game Week - {props.bestGWPlayer.round}</h3>
                </ParallaxLayer>
                <ParallaxLayer offset={4} speed={0.5} className="invisible lg:visible">
                ...
                <ParallaxLayer offset={5} factor={2} className="bg-neutral-900">
                    <div className="flex flex-col m-4 mt-40 md:m-40 mb-36">
                        <h2 className="w-full lg:w-2/3 h-full font-poppins text-6xl sm:text-8xl font-bold text-white">Points By Gameweek</h2>
                ...
                <ParallaxLayer offset={7} className="bg-neutral-900">
                    ...
                    <div className="flex flex-col lg:flex-row w-full m-4 mt-40 md:m-40">
                        <div className="flex flex-col mr-10 w-5/6 md:w-3/5">
                        ...
                        <div className="mb-0 mt-4 lg:mt-auto">
                ...
                <ParallaxLayer offset={8} id="faq" className="bg-background">
                    <div className="flex flex-wrap items-center justify-center justify-around w-full h-full">
                        ...
                        <div className="grid grid-flow-row-dense gap-6 lg:grid-cols-3 lg:grid-rows-2 w-2/5 h-3/5 mr-40 md:mr-20">
                            {FAQ_DATA.map((item) => {
                                return (
                                    <InfoCard
                                        key={item.key}
...
export async function getServerSideProps({ req, res }) {
    ...
    const playerData = await getTopPlayerStats(data);

    return {
        props: {
            total_players: data.total_players,
            bestGWPlayer: playerData,
