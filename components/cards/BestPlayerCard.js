...
export default function BestPlayerCard(props) {
    ...
    return (
        <div className="flex h-full w-full justify-between">
            <div className=" rounded-r-lg h-5/6 w-2/5 bg-white">
                <motion.div
                    ...
                    <motion.div className="h-full w-full" variants={cardVariants}>
                        <div className="flex h-full w-full">
                            <div className="flex flex-col justify-center w-full">
                                <h2 className="font-poppins w-full font-bold bg-clip-text bg-neutral-900
                                        text-transparent text-8xl ml-16 m-10">
                                    Erling Haaland
                                </h2>
                                <div className="flex flex-col text-center m-10">
                                    <div className="flex justify-evenly">
                                        <div className="bg-neutral-900 shadow-lg rounded-lg px-3 py-5">
                                            <h1 className="font-poppins font-black bg-clip-text bg-gradient-to-tr from-purple-400 to-pink-600
                                            text-transparent text-8xl m-4">3</h1>
                                        </div>
                                        <div className="bg-neutral-900 shadow-lg rounded-lg px-3 py-5">
                                            <h1 className="font-poppins font-black bg-clip-text bg-gradient-to-tr from-purple-400 to-pink-600
                                            text-transparent text-8xl m-4">2</h1>
                                        </div>
                                        <div className="bg-neutral-900 shadow-lg rounded-lg px-3 py-5">
                                            <h1 className="font-poppins font-black bg-clip-text bg-gradient-to-tr from-purple-400 to-pink-600
                                            text-transparent text-8xl m-4">38</h1>
                                        </div>
                                    </div>
                                    {/*<h1 className="font-poppins font-black bg-clip-text bg-gradient-to-tr from-purple-400 to-pink-600*/}
